...
Detects repeated AWS Console login failures.

## 1. Rule Details

```text
Rule Name: Multiple Failed Console Logins
Severity: High
Risk Score: 59
...
```text
Multiple ConsoleLogin Failure events.
```

## 4. Why This Matters

Repeated failures may indicate brute force, password spraying, or account access issues.

## 5. Test Procedure

Fail AWS Console login several times using a test IAM user.
