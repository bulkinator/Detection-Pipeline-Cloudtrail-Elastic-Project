# Runbook: Suspicious Console Login

This runbook explains how to investigate suspicious AWS Console login activity.
...
Console login alerts may indicate password guessing, missing MFA, root account usage, or unauthorized access attempts.
