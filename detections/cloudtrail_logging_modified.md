...
Detects CloudTrail logging configuration changes.

## 1. Rule Details

```text
Rule Name: AWS CloudTrail Logging Disabled or Modified
Severity: High
Risk Score: 73
...
Attackers may modify or disable logging to hide malicious activity.

## 5. Test Procedure

Run a safe CloudTrail update such as enabling log file validation.
...
![Evidence Screenshot](../screenshots/discover-cloudtrail-events.png)
