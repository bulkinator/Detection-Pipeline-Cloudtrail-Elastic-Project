...
Detects changes to S3 bucket versioning.

## 1. Rule Details

```text
Rule Name: S3 Bucket Versioning Changed
Severity: Medium
Risk Score: 61
...
```kql
data_stream.dataset:"aws.cloudtrail" and event.provider:"s3.amazonaws.com" and event.action:"PutBucketVersioning"
```
...
Suspending versioning can reduce recovery options after deletion or overwrite.

## 5. Test Procedure

Enable or suspend versioning on a temporary test bucket.
